                ...
                <section className="search">
                    <div className="container">
                        <div className="search-box">
                            ...
                            />
                            <button className="btn btn-primary search-btn" onClick={handelSearchArray}>
                                <img className="search-btn__icon" src="/images/search.svg" alt="search" width="14" height="14" />
